...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					...
					<li><i class="fa fa-phone" aria-hidden="true"></i>+92300-00-00</li>	
					<li class="s-bar">
						<div class="search">
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+9559688574</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">INFO@SUNRISE.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong> Himalayas, India</p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2022 SUNRISE . All Rights Reserved | Design by <a href="index.php">Akalya G</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
